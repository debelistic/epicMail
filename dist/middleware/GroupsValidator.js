...
var ValidateGroupsInput = {
  addGroup: function () {
    ...
    function addGroup(_x, _x2) {
      return _addGroup.apply(this, arguments);
    }

    return addGroup;
  }(),
  verifyMembermail: function () {
    var _verifyMembermail = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return _db.default.query(checkMemberEmailQuery, [req.body.membermail]);
    ...
    function verifyMembermail(_x3, _x4) {
      return _verifyMembermail.apply(this, arguments);
    }

    return verifyMembermail;
  }(),
  addAdmin: function () {
    var _addAdmin = _asyncToGenerator(
    /*#__PURE__*/
