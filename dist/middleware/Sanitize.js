...
var Sanitize = {
  ...
  lowerCaseInput: function () {
    var _lowerCaseInput = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(req, res, next) {
      var _arr2, _i2, _arr2$_i, key, value;
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              if (req.body.username) {
                // eslint-disable-next-line no-restricted-syntax
                _arr2 = Object.entries(req.body);

                for (_i2 = 0; _i2 < _arr2.length; _i2++) {
                  _arr2$_i = _slicedToArray(_arr2[_i2], 2), key = _arr2$_i[0], value = _arr2$_i[1];
                  req.body[key] = value.trim();
                }
              }
    ...
    function lowerCaseInput(_x4, _x5, _x6) {
      return _lowerCaseInput.apply(this, arguments);
    }
